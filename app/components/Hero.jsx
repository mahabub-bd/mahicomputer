...
const Hero = () => {
  return (
    <div className="bg-gradient-to-r from-cyan-900 to-blue-900 xl:h-[50vh] md:h-[90vh] bg-clip-padding ">
      <div className={`${styles.boxWidth}    `}>
        <div className={`${styles.flexCenter} flex-col`}>
          <h2 className={`${styles.heading2} text-white xl:py-10 xs:py-5 text-center `}>
            <span className="text-[#FFB802] animate-charcter">
              মাহি কম্পিউটার ট্রেনিং ইনস্টিটিউট
            </span>
          </h2>
          <p className={` text-lg  mt-5 leading-10 text-white text-center p-2 `}>
          ...
          >
            কোর্স মেয়াদ: 03 মাস, 06 মাস, 1 বছর মেয়াদী কোর্স ।
          </p>
