const styles = {
  boxWidth: "xl:max-w-[1300px] lg:max-w-[1200px] w-full mx-auto",
  ...
  mobileMenu:
    "font-plusjakarta font-normal text-white hover:text-dimWhite cursor-pointer text-[16px] [&:not(:last-child)]:mb-2 font-semibold   ",
};
